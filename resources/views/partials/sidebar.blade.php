    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <!-- eWallet - Admin Only -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('ewallets.*') ? 'active' : '' }}" href="{{ route('ewallets.index') }}">
                        <i class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('payments.*') ? 'active' : '' }}" href="{{ route('payments.index') }}">
                        ...
                        <span class="item-name">Tagihan/Pembayaran</span>
                    </a>
                </li>

                <!-- Laporan - Both Admin & Kasir -->
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="reports-menu" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('reports.customer_payment') ? 'active' : '' }}"
                                href="{{ route('reports.customer_payment') }}">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <circle cx="12" cy="12" r="8" />
                                ...
                                <span class="item-name">Status Pembayaran</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('reports.financial') ? 'active' : '' }}"
                                ...
                                <span class="item-name">Pendapatan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('reports.invoices.all') ? 'active' : '' }}"
                                href="{{ route('reports.invoices.all') }}">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <circle cx="12" cy="12" r="8" />
