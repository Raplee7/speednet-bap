                ...
                <div class="card-body">
                    <form action="{{ route('ewallets.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_ewallet" class="form-control" id="nama_ewallet" required>
                        </div>
                        <div class="mb-3">
                            <label for="no_ewallet" class="form-label">Nomor E-Wallet</label>
                            <input type="text" name="no_ewallet" class="form-control" id="no_ewallet" required>
                        </div>
                        <div class="mb-3">
