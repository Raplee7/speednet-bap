    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a class="btn-getstarted flex-md-shrink-0" href="#" data-bs-toggle="modal"
                data-bs-target="#customerLoginModal">Login</a>
            ...
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-body p-4 p-lg-5">
                    <form method="POST" action="{{ route('customer.login.attempt') }}"
                        id="customerLoginFormInsideModal">
                        @csrf

                        {{-- Menampilkan error validasi dari error bag 'customer_login' --}}
                        ...
                        <div class="mb-3">
                            ...
                            <label for="modal_active_user" class="form-label">Active User</label>
                            <input id="modal_active_user" type="text"
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="remember_modal"
                                    id="modal_remember_customer" {{ old('remember_modal') ? 'checked' : '' }}>
                                <label class="form-check-label" for="modal_remember_customer">
                                    Ingat Saya
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <small class="text-muted">Lupa Active User atau password? <br>Silakan hubungi layanan pelanggan
                            kami.</small>
                    </div>
                </div>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (customerLoginModalElement) {
                    ...
                    console.error(
                        "Elemen modal dengan ID 'customerLoginModal' tidak ditemukan untuk ditampilkan setelah error."
                    );
                }
            });
        </script>
